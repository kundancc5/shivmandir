...
$this->sections['wprt_blog_single_general'] = array(
	...
	'settings' => array(
		array(
			...
			'control' => array(
				'type' => 'wprt-heading',
				'label' => esc_html__( 'Media', 'fundrize' ),
			),
		),
		array(
			...
			'default' => true,
			'control' => array(
				'label' => esc_html__( 'Enable Post Media on Single Post', 'fundrize' ),
				'type' => 'checkbox',
			),
		),
		array(
			...
			'control' => array(
				'type' => 'wprt-heading',
				'label' => esc_html__( 'Meta', 'fundrize' ),
			),
		),
		array(
			'id' => 'blog_single_meta',
			'default' => true,
			'control' => array(
				'label' => esc_html__( 'Enable Post Meta on Single Post', 'fundrize' ),
				'type' => 'checkbox',
			),
		),
		array(
		...
		array(
			...
			'control' => array(
				'type' => 'wprt-heading',
				'label' => esc_html__( 'Title', 'fundrize' ),
			),
		),
		array(
			...
			'default' => true,
			'control' => array(
				'label' => esc_html__( 'Enable Post Title on Single Post', 'fundrize' ),
				'type' => 'checkbox',
			),
		),
		array(
			...
			'control' => array(
				'type' => 'text',
				'label' => esc_html__( 'Title Margin', 'fundrize' ),
				'description' => esc_html__( 'Top Right Bottom Left. Default: 0 0 10px 0.', 'fundrize' ),
			),
			'inline_css' => array(
		...
		array(
			...
			'control' => array(
				'type' => 'wprt-heading',
				'label' => esc_html__( 'Tags', 'fundrize' ),
			),
		),
		array(
			'id' => 'blog_single_tags',
			'default' => true,
			'control' => array(
				'label' => esc_html__( 'Enable Post Tags on Single Post', 'fundrize' ),
				'type' => 'checkbox',
			),
		),
	),
...
$this->sections['wprt_blog_single_post_author'] = array(
	'title' => esc_html__( 'Blog Single Post - Author', 'fundrize' ),
	'panel' => 'wprt_blogsingle',
	'settings' => array(
		array(
		...
		array(
			...
			'control' => array(
				'type' => 'color',
				'label' => esc_html__( 'Name Color', 'fundrize' ),
			),
			'inline_css' => array(
		...
		array(
			...
			'control' => array(
				'type' => 'text',
				'label' => esc_html__( 'Image Width', 'fundrize' ),
			),
			'inline_css' => array(
				'target' => array(
		...
		array(
			...
			'control' => array(
				'type' => 'text',
				'label' => esc_html__( 'Image Right Margin', 'fundrize' ),
...
$this->sections['wprt_blog_single_post_comment'] = array(
	'title' => esc_html__( 'Blog Single Post - Comment', 'fundrize' ),
	'panel' => 'wprt_blogsingle',
	'settings' => array(
		array(
		...
		array(
			...
			'control' => array(
				'type' => 'text',
				'label' => esc_html__( 'Title Bottom Margin', 'fundrize' ),
			),
			'inline_css' => array(
				'target' => array(
					'.comments-area .comments-title',
		...
		array(
			...
			'control' => array(
				'type' => 'wprt-heading',
				'label' => esc_html__( 'Comment List', 'fundrize' ),
			),
		),
		array(
			...
			'control' => array(
				'type' => 'text',
				'label' => esc_html__( 'Avatar Width', 'fundrize' ),
			),
			'inline_css' => array(
		...
		array(
			...
			'control' => array(
				'type' => 'text',
				'label' => esc_html__( 'Avatar Right Margin', 'fundrize' ),
		...
		array(
			...
			'control' => array(
				'type' => 'text',
				'label' => esc_html__( 'Avatar Rounded', 'fundrize' ),
				'description' => esc_html__( 'Example: 10px. 0px is square.', 'fundrize' ),
			),
			'inline_css' => array(
				'target' => '.comment-list article .gravatar',
				'alter' => 'border-radius',
		...
		array(
			...
			'control' => array(
				'type' => 'text',
				'label' => esc_html__( 'Article Bottom Margin', 'fundrize' ),
				'description' => esc_html__( 'Example: 40px.', 'fundrize' ),
			),
			'inline_css' => array(
		...
		array(
			...
			'control' => array(
				'type' => 'wprt-heading',
				'label' => esc_html__( 'Comment Form', 'fundrize' ),
			),
		),
		array(
			...
			'control' => array(
				'type' => 'color',
				'label' => esc_html__( 'Form Border Color', 'fundrize' ),
			),
			'inline_css' => array(
		...
		array(
			...
			'control' => array(
				'type' => 'text',
				'label' => esc_html__( 'Form Rounded', 'fundrize' ),
		...
		array(
			...
			'control' => array(
				'type' => 'text',
				'label' => esc_html__( 'Form Border Width', 'fundrize' ),
			),
			'inline_css' => array(
				'target' => '.name-wrap input, .email-wrap input, .message-wrap textarea',
				'alter' => 'border-width',
